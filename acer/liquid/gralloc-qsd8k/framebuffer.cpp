...
#define WS_AS_RATIO_H (4.5/100)  // Action Safe vertical limit for 16:9
#define WS_AS_RATIO_W (3.5/100)  // Action Safe horizontal limit for 16:9
#define NON_WS_AS_RATIO_H (8.0/100) //Action safe Vertical limit for 4:3
#define NON_WS_AS_RATIO_W (5.0/100) //Action safe Horizontal limit for 4:3
        ...
        if (m->pobjOverlay) {
            ...
            if (!m->enableHDMIOutput)
                ...
                if (pTemp->isChannelUP()) {
                    ...
                    if(height == HEIGHT_480P) {
                        aswidth = (int)((float)width  - (float)(width * NON_WS_AS_RATIO_W));
                        asheight = (int)((float)height  - (float)(height * NON_WS_AS_RATIO_H));
                        x1 = (int)(width * NON_WS_AS_RATIO_W) / 2;
                        y1 = (int)(height * NON_WS_AS_RATIO_H) / 2;
                    } else {
                        aswidth = (int)((float)width  - (float)(width * WS_AS_RATIO_W));
                        asheight = (int)((float)height  - (float)(height * WS_AS_RATIO_H));
                        x1 = (int)(width * WS_AS_RATIO_W) / 2;
                        y1 = (int)(height * WS_AS_RATIO_H) / 2;
                    }
