...
#define CAMERA_MIN_CONTRAST 30
#define CAMERA_MAX_CONTRAST 60
#define CAMERA_MIN_SHARPNESS 0
#define CAMERA_MIN_EXPOSURE_COMPENSATION 0
#define CAMERA_MAX_SHARPNESS 15
#define CAMERA_MIN_SATURATION 0
#define CAMERA_MAX_SATURATION 30
#define CAMERA_MAX_EXPOSURE_COMPENSATION 8
#define CAMERA_DEF_SHARPNESS 17
#define CAMERA_DEF_CONTRAST 8
#define CAMERA_DEF_SATURATION 7
